...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        if ((this.id == stud.id) && (this.lastName.equals(stud.lastName) == true) && (this.firstName.equals(stud.firstName) == true) &&
                (this.averageGrade.equals(stud.averageGrade) == true))
            return true;
        return false;
    ...
    @Override
    public int hashCode() {
        return this.id.hashCode() + this.firstName.hashCode() + this.lastName.hashCode() + this.averageGrade.hashCode();
